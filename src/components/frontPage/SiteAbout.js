...
const AboutParagraph = () => {
    return (
        ...
        <p>
            What is this website? I made it primarily as a project to help me learn web technologies. Before this site, I knew very little about anything front-end related, and even less about backend. As of now I have not only this front-end done, but if you take a look at my <a className="text-highlight-100 hover:texthighlight-200" href="/devblog" target="_blank" rel="noreferrer">devblog</a> I've learned everything necessary to set up a database with MongoDB, and an API to communicate back and forth with my database to create users and allow for login as well as to create posts. I learned about and set up reauthentication through the usage of JSON Web Tokens and React Redux, have password hashing so that passwords are not stored in plain text within the database, and have implemented a whole bunch of other things that took me way longer than it should have. Note that this is a project that I'm working on while balancing the workload of all my classes, and is far from perfect. If you find any glaring issues don't hesitate to email me and let me know!
